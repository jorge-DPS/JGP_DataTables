...
urlpatterns = [
    ...
    #prueba de deposito
    #path('', include('apps.deposito.urls', namespace='lista_deposito')),
    #prueba de zonas
    #path('', include('apps.zona.urls', namespace='lista_zona')),
    #grupo fuera de api
    #path('', include('apps.grupo.urls', namespace='lista_grupo')),
    #*********************REPORTES EN PDF********************************************
    path('reporte/', include('apps.cajas.urls', namespace='reporte_caja')),
    path('reporte_datos/', include('apps.clientes.urls', namespace='reporte_clientes')),
    path('reporte_creditos/', include('apps.credito.urls', namespace='reporte_liquidacion')),
    #------------datatables
    path('tablas/', include('apps.albums.urls', namespace='datatablas')),
    #path('reporte_rutas/', include('apps.credito.urls', namespace='reporte_rutas')),
